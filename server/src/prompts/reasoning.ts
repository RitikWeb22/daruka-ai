import { EnvironmentalState, ScientificEvidenceItem, CausalLink } from '../environmental/schema';

export function buildSystemReasoningPrompt(): string {
...
export function buildUserReasoningPrompt(params: {
  userQuestion: string;
