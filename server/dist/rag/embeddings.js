...
exports.LocalSemanticEmbeddingService = void 0;
...
class LocalSemanticEmbeddingService {
    ...
    generateVector(text) {
        ...
        for (let i = 0; i < words.length; i++) {
            ...
            const hash = crypto_1.default.createHash('sha256').update(word).digest();
            for (let d = 0; d < 8; d++) {
            ...
            if (i < words.length - 1) {
                ...
                const biHash = crypto_1.default.createHash('md5').update(bigram).digest();
...
exports.LocalSemanticEmbeddingService = LocalSemanticEmbeddingService;
