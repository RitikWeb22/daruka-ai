...
exports.globalResponseAgent = exports.ResponseAgent = void 0;
class ResponseAgent {
    assembleResponse(params) {
        const { state, completeness, causalChains, recommendations, evidence, llmCustomText, isClarificationNeeded } = params;
        let md = '';
...
To formulate an exact diagnosis calibrated to your local soil hydrology and crop dynamics, please clarify the key variables below. In the interim, authoritative scientific literature provides the following foundational interventions:\n\n`;
        ...
        const assessmentSummary = llmCustomText || (`Your current environmental conditions indicate that biodiversity is constrained by the multi-variable interaction between ` +
...
exports.globalResponseAgent = new ResponseAgent();
