...
exports.globalRecommendationAgent = exports.RecommendationAgent = void 0;
class RecommendationAgent {
    generateRecommendations(state, analysis, evidence, userQuery) {
...
exports.globalRecommendationAgent = new RecommendationAgent();
